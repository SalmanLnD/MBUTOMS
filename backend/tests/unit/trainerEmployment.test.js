...
test('relocated trainer is marked relocated after the last working date and never treated as exit', () => {
  const trainer = {
  ...
  assert.equal(shouldAutoMarkTrainerRelocated(trainer, new Date('2026-08-20T12:00:00.000Z')), false);

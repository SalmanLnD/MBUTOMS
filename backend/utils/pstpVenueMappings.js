...
export const PSTP_TRAINER_VENUE_SLOTS = {
  ...
  [PSTP_T9_TRAINER_CODE]: [
    ...
    { day: 'Monday', slot: 'S3', venue: '4420' },
    { day: 'Monday', slot: 'S4', venue: '2603' },
    { day: 'Tuesday', slot: 'S1', venue: '4418' },
    { day: 'Tuesday', slot: 'S2', venue: '4418' },
    { day: 'Tuesday', slot: 'S3', venue: '132' },
    { day: 'Tuesday', slot: 'S4', venue: '4420' },
    { day: 'Wednesday', slot: 'S1', venue: '4420' },
    { day: 'Wednesday', slot: 'S2', venue: '2603' },
    { day: 'Wednesday', slot: 'S3', venue: '132' },
    { day: 'Wednesday', slot: 'S4', venue: '132' },
    { day: 'Thursday', slot: 'S1', venue: '4418' },
    { day: 'Thursday', slot: 'S2', venue: '4420' },
    { day: 'Thursday', slot: 'S3', venue: '2603' },
    { day: 'Friday', slot: 'S3', venue: '4418' },
